...
const topicPools: Record<string, Record<Tier, string[]>> = {
  python: {
    ROOKIE: ["string methods", "dictionaries basics", "tuples", "type casting", "math operations", "boolean logic", "string formatting", "list slicing"],
    "CHAMPI0N": ["file handling", "error handling", "list comprehensions", "dictionary comprehensions", "lambda functions", "map/filter/reduce", "sets", "string methods advanced"],
    ELITE: ["decorators", "generators", "context managers", "OOP inheritance", "metaclasses", "async/await", "type hints", "dataclasses"],
  },
  javascript: {
    ROOKIE: ["string methods", "number methods", "if/else", "switch", "loops", "template literals", "comparison operators", "type coercion"],
    "CHAMPI0N": ["closures", "prototypes", "classes", "error handling", "regex", "modules (import/export)", "iterators", "generators"],
    ELITE: ["proxy/reflect", "symbols", "WeakMap/WeakSet", "event loop", "web workers", "service workers", "design patterns", "TypedArrays"],
  },
  htmlcss: {
    ROOKIE: ["semantic HTML", "lists & tables", "links & images", "colors & units", "box model", "text styling", "backgrounds", "borders"],
    "CHAMPI0N": ["responsive design", "media queries", "CSS variables", "pseudo-classes", "pseudo-elements", "position property", "z-index", "overflow"],
    ELITE: ["CSS container queries", "CSS nesting", "CSS layers", "view transitions", "scroll snap", "aspect-ratio", "clamp()", "has() selector"],
  },
  typescript: {
    ROOKIE: ["type assertions", "union types", "literal types", "type narrowing", "arrays & tuples", "function types", "optional chaining", "nullish coalescing"],
    "CHAMPI0N": ["discriminated unions", "type predicates", "indexed access types", "template literal types", "recursive types", "module augmentation", "declaration merging", "overloads"],
    ELITE: ["infer keyword", "distributive conditional types", "variadic tuple types", "satisfies operator", "const assertions", "branded types", "builder pattern types", "HKTs workarounds"],
  },
  java: {
    ROOKIE: ["arrays", "string handling", "control flow", "methods", "packages", "type casting", "scanner input", "formatting output"],
    "CHAMPI0N": ["interfaces", "abstract classes", "enums", "annotations", "inner classes", "comparable/comparator", "iterators", "optional"],
    ELITE: ["multithreading", "concurrent collections", "reflection", "design patterns", "functional interfaces", "records", "sealed classes", "modules (JPMS)"],
  },
  cpp: {
    ROOKIE: ["arrays", "strings (std::string)", "control flow", "functions", "enums", "typedef/using", "auto keyword", "range-based for"],
    "CHAMPI0N": ["inheritance", "operator overloading", "friend functions", "namespaces", "file I/O", "exception handling", "functors", "iterators"],
    ELITE: ["concepts (C++20)", "coroutines", "constexpr", "type traits", "perfect forwarding", "CRTP", "fold expressions", "modules (C++20)"],
  },
  rust: {
    ROOKIE: ["variables & mutability", "data types", "functions", "control flow", "string vs &str", "vectors", "option & result", "error handling basics"],
    "CHAMPI0N": ["iterators & closures", "smart pointers", "collections", "modules & crates", "testing", "error handling advanced", "type aliases", "associated types"],
    ELITE: ["unsafe code", "macros", "async runtime", "pin & unpin", "PhantomData", "trait objects vs generics", "interior mutability", "zero-cost abstractions"],
  },
  go: {
    ROOKIE: ["variables & types", "functions", "control flow", "arrays vs slices", "strings & runes", "packages", "pointers", "defer"],
    "CHAMPI0N": ["methods & receivers", "composition", "testing", "init functions", "context package", "io.Reader/Writer", "encoding/json", "http package"],
    ELITE: ["generics (Go 1.18+)", "reflection", "unsafe package", "cgo", "profiling & pprof", "race detector", "sync primitives", "plugin system"],
  },
  sql: {
    ROOKIE: ["INSERT/UPDATE/DELETE", "data types", "constraints", "primary keys", "foreign keys", "NULL handling", "aliases", "CASE expressions"],
    "CHAMPI0N": ["window functions", "views", "stored procedures", "transactions", "ACID properties", "normalization", "denormalization", "triggers"],
    ELITE: ["query optimization", "execution plans", "partitioning", "materialized views", "recursive CTEs", "pivot/unpivot", "JSON operations", "full-text search"],
  },
};
...
function generateProceduralQuiz(topic: string, langName: string, tier: Tier): QuizQuestion[] {
  return [
    ...
    },
    {
      ...
      correct: tier === 'ROOKIE' ? 0 : tier === 'CHAMPI0N' ? 1 : 3,
