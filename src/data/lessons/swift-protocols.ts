// Pre-written lessons for Swift Module: Protocols

export const swiftProtocolsLessons = [
  {
    title: "What is Protocols?",
    definition: "Protocols in Swift define contracts (blueprints) for methods, properties, and requirements that conforming types must implement. They enable polymorphism without inheritance and are the foundation of Swift’s design.",
    explanation: `Protocols is a core concept in Swift that every developer needs to master. It provides the foundation for writing efficient, safe, and maintainable code.
...
Swift's approach to protocols is unique among programming languages, offering specific guarantees and trade-offs that shape how you design your programs.

By mastering protocols, you unlock powerful patterns and idioms that are standard in professional Swift development.`,
    code: `// Protocols in Swift - Basics
import Foundation
...
print("\(hero.name): \(hero.hp)/\(hero.maxHp)")`,
    breakdown: `\u2022 The basic declaration shows how to define and use protocols in Swift.\n\n\u2022 Type safety ensures the compiler catches errors before runtime.\n\n\u2022 Standard library integration makes common operations concise.\n\n\u2022 Comments explain each line's purpose for learners.\n\n\u2022 The example demonstrates the most common usage pattern.`,
    summary: "Protocols in Swift provides define contracts (blueprints) for methods, properties, and requirements that conforming types must implement. They enable polymorphism without inheritance and are the foundation of Swift’s design.. It's fundamental to writing correct, efficient Swift code."
  },
  {
    title: "How Protocols works",
    definition: "Protocols works by the compiler verifying that conforming types provide all required members. Protocol extensions add default implementations. Existential types (any Protocol) enable dynamic dispatch.",
    explanation: `Under the hood, protocols in Swift involves specific compile-time and runtime mechanisms. The interpreter enforces rules that ensure correctness.
...
Understanding how protocols works internally helps you predict behavior, debug issues, and write more efficient code.
...
enum GameState {
    ...
    summary: "Protocols works through the compiler verifying that conforming types provide all required members. Protocol extensions add default implementations. Existential types (any Protocol) enable dynamic dispatch.. Understanding internals helps you write better code and debug effectively."
  },
  {
    title: "Protocols syntax & usage",
    definition: "Swift protocols syntax includes protocol Name { requirements }, extension for defaults, associatedtype for generics, protocol composition (Protocol1 & Protocol2), and conditional conformance.",
    explanation: `Swift provides clear syntax for protocols with several variations depending on your needs. The standard library builds extensively on these foundations.
...
Modern Swift continues to evolve, adding syntactic improvements while maintaining backwards compatibility with existing code.`,
    code: `// Protocols - Syntax patterns
...
case .failure(let error):
    ...
    summary: "Swift syntax for protocols is expressive and type-safe. Multiple forms serve different needs from simple to complex use cases."
  },
  {
    title: "Practical examples of Protocols",
    definition: "In real applications, protocols defines shared behavior across unrelated types, enables testing with mock implementations, and powers SwiftUI’s View protocol and Codable serialization.",
    explanation: `Real-world Swift applications use protocols for data processing, system design, and performance-critical code paths. These patterns appear in production codebases everywhere.

Game development, web services, and system programming all leverage these concepts extensively.

Open-source Swift projects provide excellent examples of protocols in action. Studying them accelerates your learning.
...
The patterns you learn here transfer to related problems. Once you understand the principles, applying them to new situations becomes natural.`,
    code: `// Protocols - Practical game system
...
func handle(_ event: GameEvent) {
    ...
    summary: "Real applications demonstrate protocols in game systems, data processing, and service design. The patterns are universal across Swift projects."
  },
  {
    title: "Protocols best practices",
    definition: "Best practices for protocols include keeping protocols small and focused, providing default implementations via extensions, using protocol composition over inheritance, conforming to standard protocols (Equatable, Hashable, Codable).",
    explanation: `Professional Swift code follows established conventions for protocols that emerge from years of community experience and real-world usage.

Code review standards emphasize proper usage of these patterns. Following best practices signals professional competence.

Testing is easier when protocols is used correctly as well-structured code is inherently more testable.
...
// DO: Use if-let or guard-let instead`,
    ...
    summary: "Best practices ensure code quality: keeping protocols small and focused, providing default implementations via extensions, using protocol composition over inheritance, conforming to standard protocols (Equatable, Hashable, Codable).. Following conventions makes code maintainable and professional."
  }
];
