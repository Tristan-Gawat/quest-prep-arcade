// Pre-written lessons for C++ Module: Standard Template Library

export const cppSTLLessons = [
  {
    title: "What is Standard Template Library?",
    definition: "Standard Template Library in C++ provides generic containers (vector, map, set), algorithms (sort, find, transform), and iterators that work together for efficient data processing.",
    explanation: `Standard Template Library is a core concept in C++ that every developer needs to master. It provides the foundation for writing efficient, safe, and maintainable code.
...
C++'s approach to standard template library is unique among programming languages, offering specific guarantees and trade-offs that shape how you design your programs.

By mastering standard template library, you unlock powerful patterns and idioms that are standard in professional C++ development.`,
    code: `// Standard Template Library - Basic usage in C++
#include <iostream>
#include <memory>
#include <vector>
using namespace std;
...
int main() {
    ...
    cout << "Standard Template Library in C++" << endl;
    ...
    breakdown: `\u2022 The basic declaration shows how to define and use standard template library in C++.\n\n\u2022 Type safety ensures the compiler catches errors before runtime.\n\n\u2022 Standard library integration makes common operations concise.\n\n\u2022 Comments explain each line's purpose for learners.\n\n\u2022 The example demonstrates the most common usage pattern.`,
    summary: "Standard Template Library in C++ provides provides generic containers (vector, map, set), algorithms (sort, find, transform), and iterators that work together for efficient data processing.. It's fundamental to writing correct, efficient C++ code."
  },
  {
    title: "How Standard Template Library works",
    definition: "Standard Template Library works by using templates for type-generic code. Containers manage memory, iterators provide uniform access, and algorithms operate through iterator pairs.",
    explanation: `Under the hood, standard template library in C++ involves specific compile-time and runtime mechanisms. The compiler enforces rules that ensure correctness.
...
Understanding how standard template library works internally helps you predict behavior, debug issues, and write more efficient code.
...
This knowledge separates intermediate developers from advanced ones and is the difference between using a feature and truly understanding it.`,
    code: `// Standard Template Library - How it works internally
#include <iostream>
using namespace std;
...
public:
    ...
    summary: "Standard Template Library works through using templates for type-generic code. Containers manage memory, iterators provide uniform access, and algorithms operate through iterator pairs.. Understanding internals helps you write better code and debug effectively."
  },
  {
    title: "Standard Template Library syntax & usage",
    definition: "C++ standard template library syntax includes container declarations (vector<T>), iterator usage (begin/end), algorithm calls (sort, find_if), and range-based for loops.",
    explanation: `C++ provides clear syntax for standard template library with several variations depending on your needs. The standard library builds extensively on these foundations.
...
Modern C++ continues to evolve, adding syntactic improvements while maintaining backwards compatibility with existing code.`,
    code: `// Standard Template Library - Syntax patterns
#include <iostream>
#include <memory>
#include <vector>
#include <algorithm>
...
void lambdaDemo() {
    ...
    summary: "C++ syntax for standard template library is expressive and type-safe. Multiple forms serve different needs from simple to complex use cases."
  },
  {
    title: "Practical examples of Standard Template Library",
    definition: "In real applications, standard template library provides the building blocks for game systems (vectors for entities, maps for lookups, sets for unique collections, algorithms for processing).",
    explanation: `Real-world C++ applications use standard template library for data processing, system design, and performance-critical code paths. These patterns appear in production codebases everywhere.

Game development, web services, and system programming all leverage these concepts extensively.

Open-source C++ projects provide excellent examples of standard template library in action. Studying them accelerates your learning.
...
The patterns you learn here transfer to related problems. Once you understand the principles, applying them to new situations becomes natural.`,
    code: `// Standard Template Library - Practical game example
#include <iostream>
#include <vector>
#include <memory>
#include <algorithm>
...
int main() {
    ...
    summary: "Real applications demonstrate standard template library in game systems, data processing, and service design. The patterns are universal across C++ projects."
  },
  {
    title: "Standard Template Library best practices",
    definition: "Best practices for standard template library include preferring vector as default container, using reserve() for known sizes, choosing the right container for access patterns, and using algorithms over manual loops.",
    explanation: `Professional C++ code follows established conventions for standard template library that emerge from years of community experience and real-world usage.

Code review standards emphasize proper usage of these patterns. Following best practices signals professional competence.

Testing is easier when standard template library is used correctly as well-structured code is inherently more testable.
...
Performance and safety are balanced through careful application of these principles. Knowing when to optimize and when readability matters more is a key skill.`,
    code: `// Standard Template Library - Best practices
#include <memory>
#include <vector>
#include <string>
using namespace std;
...
public:
    ...
    summary: "Best practices ensure code quality: preferring vector as default container, using reserve() for known sizes, choosing the right container for access patterns, and using algorithms over manual loops.. Following conventions makes code maintainable and professional."
  }
];
