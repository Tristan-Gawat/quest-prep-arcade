// Pre-written lessons for Ruby Module: Classes & Objects

export const rubyClassesLessons = [
  {
    title: "What is Classes & Objects?",
    definition: "Classes & Objects in Ruby are blueprints for objects supporting encapsulation, inheritance, mixins, and open classes. Ruby is purely object-oriented — everything is an object, even numbers and nil.",
    explanation: `Classes & Objects is a core concept in Ruby that every developer needs to master. It provides the foundation for writing efficient, safe, and maintainable code.
...
Ruby's approach to classes & objects is unique among programming languages, offering specific guarantees and trade-offs that shape how you design your programs.

By mastering classes & objects, you unlock powerful patterns and idioms that are standard in professional Ruby development.`,
    code: `# Classes & Objects in Ruby - Basics
...
hero.take_damage(40)
puts hero`,
    breakdown: `\u2022 The basic declaration shows how to define and use classes & objects in Ruby.\n\n\u2022 Type safety ensures the compiler catches errors before runtime.\n\n\u2022 Standard library integration makes common operations concise.\n\n\u2022 Comments explain each line's purpose for learners.\n\n\u2022 The example demonstrates the most common usage pattern.`,
    summary: "Classes & Objects in Ruby provides are blueprints for objects supporting encapsulation, inheritance, mixins, and open classes. Ruby is purely object-oriented — everything is an object, even numbers and nil.. It's fundamental to writing correct, efficient Ruby code."
  },
  {
    title: "How Classes & Objects works",
    definition: "Classes & Objects works by sending messages to objects. Method lookup follows the ancestor chain (class -> modules -> superclass). Ruby uses dynamic dispatch — the object’s class determines which method runs.",
    explanation: `Under the hood, classes & objects in Ruby involves specific compile-time and runtime mechanisms. The interpreter enforces rules that ensure correctness.
...
Understanding how classes & objects works internally helps you predict behavior, debug issues, and write more efficient code.
...
This knowledge separates intermediate developers from advanced ones and is the difference between using a feature and truly understanding it.`,
    code: `# Classes & Objects - How it works
...
puts names.map(&:capitalize) # ["Alice", "Bob", "Charlie"]`,
    ...
    summary: "Classes & Objects works through sending messages to objects. Method lookup follows the ancestor chain (class -> modules -> superclass). Ruby uses dynamic dispatch — the object’s class determines which method runs.. Understanding internals helps you write better code and debug effectively."
  },
  {
    title: "Classes & Objects syntax & usage",
    definition: "Ruby classes & objects syntax includes class Name; end, attr_accessor/reader/writer, initialize constructor, self keyword, class << self for class methods, and super for parent calls.",
    explanation: `Ruby provides clear syntax for classes & objects with several variations depending on your needs. The standard library builds extensively on these foundations.
...
Modern Ruby continues to evolve, adding syntactic improvements while maintaining backwards compatibility with existing code.`,
    code: `# Classes & Objects - Syntax patterns
...
class DynamicFinder
  def method_missing(method, *args)
    ...
    summary: "Ruby syntax for classes & objects is expressive and type-safe. Multiple forms serve different needs from simple to complex use cases."
  },
  {
    title: "Practical examples of Classes & Objects",
    definition: "In real applications, classes & objects models domain entities, implements design patterns, creates gems (libraries), and builds Rails models/controllers. Ruby’s expressiveness enables elegant OOP.",
    explanation: `Real-world Ruby applications use classes & objects for data processing, system design, and performance-critical code paths. These patterns appear in production codebases everywhere.

Game development, web services, and system programming all leverage these concepts extensively.

Open-source Ruby projects provide excellent examples of classes & objects in action. Studying them accelerates your learning.
...
The patterns you learn here transfer to related problems. Once you understand the principles, applying them to new situations becomes natural.`,
    code: `# Classes & Objects - Practical game example
...
puts "Most valuable: #{inv.max_by { |i| i[:value] }[:name]}"`,
    ...
    summary: "Real applications demonstrate classes & objects in game systems, data processing, and service design. The patterns are universal across Ruby projects."
  },
  {
    title: "Classes & Objects best practices",
    definition: "Best practices for classes & objects include using attr_accessor for simple properties, keeping classes under 100 lines, preferring composition with modules over deep inheritance, using freeze for immutability.",
    explanation: `Professional Ruby code follows established conventions for classes & objects that emerge from years of community experience and real-world usage.

Code review standards emphasize proper usage of these patterns. Following best practices signals professional competence.

Testing is easier when classes & objects is used correctly as well-structured code is inherently more testable.
...
Performance and safety are balanced through careful application of these principles. Knowing when to optimize and when readability matters more is a key skill.`,
    code: `# Classes & Objects - Best practices
...
# = for setters: name= hp=`,
    ...
    summary: "Best practices ensure code quality: using attr_accessor for simple properties, keeping classes under 100 lines, preferring composition with modules over deep inheritance, using freeze for immutability.. Following conventions makes code maintainable and professional."
  }
];
